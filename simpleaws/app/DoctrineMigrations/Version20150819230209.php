 ...
 */
class Version20150819230209 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE schedule ADD COLUMN done BOOLEAN NOT NULL DEFAULT 0');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE schedule (rowid VARCHAR(255) NOT NULL, as_group VARCHAR(255) NOT NULL, quantity INTEGER NOT NULL, create_at DATETIME NOT NULL, schedule_at DATETIME NOT NULL, run_at DATETIME DEFAULT NULL, PRIMARY KEY(rowid))');
